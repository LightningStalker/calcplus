...
If you want to install the programs, you can copy the binaries to some
place in the path. On Linux/Mac OS `/usr/bin` or `/usr/local/bin`

Not sure about Windows I haven't use in a while. If you can install and
use the Cygwin, you probably don't need me to hole you hand.
